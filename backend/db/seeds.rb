...
ApplicationRecord.transaction do 
  ...
  demo_user_2 = User.create!({
    ...
    email: 'starby@starby', 
    password: 'starby',
    shop_name: "The Real Chise Blass",
  ...
  demo_user_3 = User.create!({
    username: 'Koel Jorte', 
    email: 'ChiseBlass@Ordio', 
    password: 'chiseblass',
    shop_name: 'Chise Blass Ordio',
    location: 'Minneapolis, MN',
    cart: [],
    watchlist: []
  })
  ...
  demo_user_4 = User.create!({
    ...
    email: 'info@parksandrecpawnee.com', 
    password: 'waffles',
  ...
  demo_user_5 = User.create!({
    username: 'Gob Bluth', 
    email: 'BluthCompany@imoscar.com', 
    password: 'gobbluth',
  ...
  10.times do 
    User.create!(
      ...
      shop_name: Faker::TvShows::Community.unique.characters,
